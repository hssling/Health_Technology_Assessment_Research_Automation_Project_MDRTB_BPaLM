# 🫁 MDR-TB BPaLM Regimen Assessment Dashboard

[![Streamlit App](https://static.streamlit.io/badges/streamlit_badge_black_white.svg)](https://hta-mdrtb-bpalm.streamlit.app/)
...
An interactive Streamlit dashboard presenting the cost-effectiveness analysis of economic evaluation of bpalm regimen for multidrug-resistant tuberculosis.
...
Access the interactive dashboard at: [https://hta-mdrtb-bpalm.streamlit.app/](https://hta-mdrtb-bpalm.streamlit.app/)
...
1. **Clone the repository:**
   ```bash
   git clone https://github.com/hssling/hta-mdrtb-bpalm-dashboard.git
   cd hta-mdrtb-bpalm-dashboard
   ```
...
```bibtex
@software{siddalingaiah_mdrtb_hta_2025,
  author       = {Siddalingaiah H S},
  title        = {MDR-TB BPaLM Regimen Assessment Dashboard},
  year         = {2025},
  publisher    = {Zenodo},
  doi          = {10.5281/zenodo.123456789},
  url          = {https://hta-mdrtb-bpalm.streamlit.app/}
}
```
