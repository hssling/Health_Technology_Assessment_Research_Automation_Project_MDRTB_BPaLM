...
# Page configuration
st.set_page_config(
    page_title="MDR-TB BPaLM Regimen Assessment",
    page_icon="🫁",
    layout="wide",
...
def create_visualization(results):
    ...
    fig.update_layout(
        title='MDR-TB BPaLM Regimen Assessment',
        xaxis_title='X Axis',
        yaxis_title='Y Axis',
        showlegend=True,
        height=500
...
def main():
    ...
    # Main header
    st.markdown('<h1 class="main-header">🫁 MDR-TB BPaLM Regimen Assessment</h1>', unsafe_allow_html=True)
    st.markdown("**Economic Evaluation of BPaLM Regimen for Multidrug-Resistant Tuberculosis**")
